...
このファイルの結果はデモデータでの簡易分析です。実データの研究で採用候補として扱っている現在の既定戦略とは別物なので、実運用や paper の既定値としては [README.md](README.md) と [docs/spec.md](docs/spec.md) の 252/252・top 2・skip 0 を優先してください。
...
デモデータの範囲では、以下の設定が最もパフォーマンスが良好でした：
